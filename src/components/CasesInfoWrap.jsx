                ...
                {selectedCase === "На работу" && (
                    <>
                        <div className="CaseInfoCard">
                            <div className="Case_info_card_title">
                                Идеальные машины
                            </div>
                        ...
                        <div className="CaseInfoCard">
                            ...
                            <div className="Offer_card_container">
                                <div className="Offer_card">
                                    <div
                                        className="Offer_card_title"
                                        style={{ color: "rgb(19, 136, 8)" }}
                                    >
                                        Фикс
                                    </div>
                                    <div
                                        className="Offer_card_line"
                                        style={{
                                            backgroundColor: "rgb(19, 136, 8)",
                                        }}
                                    ></div>
                                    <div className="Offer_card_price">
                                        Цена зависит от точки назначения
                                    </div>
                                    <div className="Offer_details_view">
                                        <div className="Offer_details_item">
                                            <div className="Offer_details_item_dot_container">
                                                <div
                                                    className="Offer_details_item_dot"
                                                    style={{
                                                        backgroundColor:
                                                            "rgb(19, 136, 8)",
                                                    }}
                                            ...
                                            <div className="Offer_details_item_title">
                                                Точно знаете, куда едете
                                            </div>
                                        </div>
                                    </div>
                                    <div className="Offer_details_item">
                        ...
                        <div className="CaseInfoCard">
                            <div className="Case_info_card_title">
                                Что пригодится в пути
                            </div>
                            <div className="Feature_card_container">
                                <div
                                    className="Feature_card"
                                    style={{ paddingRright: "(0px)" }}
                                >
                                    <div className="Feature_card_left_content">
                                        <div className="Feature_card_title">
                                            Бесплатные поездки
                                        </div>
                                        <div className="Feature_card_subtitle">
                                            Которые могут с вами случаться, если
                                            приводить в Драйв друзей. До 700
                                            баллов в месяц с их поездок
                                            покрывают ваши.
                                        </div>
                                    </div>
                                    <img
                                        src={FeatureCard}
                                        className="Feature_card_image_bottom"
                                    ></img>
                                </div>
                                <div className="Car_card_shadow"></div>
                            </div>
                            ...
                            <div className="Feature_card_container">
                                ...
                                >
                                    <div className="Feature_card_left_content">
                                        ...
                                        <div className="Feature_card_subtitle">
                                            С Навигатором, Алисой и Яндекс
                                            Музыкой. Есть во многих машинах
                                            Драйва.
                                        </div>
                                    </div>
                                    <img
                                        src={FeatureCard1}
                                        class="Feature_card_image_rounded"
                                    ></img>
                                </div>
                                <div className="Car_card_shadow"></div>
                            </div>
                            ...
                            <div className="Offer_card_container">
                                <div className="Offer_card">
                                    ...
                                    <div className="Offer_details_item">
                                        ...
                                        <div className="Offer_details_item_title">
                                            Километры оплачиваются отдельно
                                        </div>
                                    </div>
                                </div>
                                <div className="Car_card_shadow"></div>
                            ...
                            <div className="Feature_card_container">
                                ...
                                >
                                    <div className="Feature_card_left_content">
                                        ...
                                        <div className="Feature_card_subtitle">
                                            Чтобы доехать на одной до другой.
                                            Например, на обычной Шкоде до
                                            фургона, который далеко.
                                        </div>
                                    </div>
                                    <img
                                        src={FeatureCard2}
                                        class="Feature_card_image_top"
                                    ></img>
                                </div>
                                <div className="Car_card_shadow"></div>
                            </div>
                            ...
                            <div className="Feature_card_container">
                                ...
                                >
                                    <div className="Feature_card_left_content">
                                        ...
                                        <div className="Feature_card_subtitle">
                                            Есть в некоторых машинах, которые
                                            легко найти в приложении по
                                            одноимённому фильтру.
                                        </div>
                                    </div>
                                    <img
                                        src={ChildSeat}
                        ...
                        <div className="CaseInfoCard">
                            ...
                            <div className="Car_card_container">
                                <div
                                    className="Car_card"
                                    style={{
                                        backgroundColor: "rgb(237, 118, 14)",
                                    }}
                                >
                                    <img
                                        src={JeepSahara}
                            ...
                            <div className="Offer_card_container">
                                <div className="Offer_card">
                                    ...
                                    <div className="Offer_details_item">
                                        ...
                                        <div className="Offer_details_item_title">
                                            Или когда не знаете, куда поедете
                                        </div>
                                    </div>
                                </div>
                                <div className="Car_card_shadow"></div>
                            ...
                            <div className="Feature_card_container">
                                ...
                                >
                                    <div className="Feature_card_left_content">
                                        ...
                                        <div className="Feature_card_subtitle">
                                            Тому, кто тоже есть в Драйве с
                                            доступом к такой же машине.
                                        </div>
                                    </div>
                                    <img
                                        src={FeatureCard3}
                                        class="Feature_card_image_bottom"
                                    ></img>
                                </div>
                                <div className="Car_card_shadow"></div>
                            </div>
                            ...
                            <div className="Feature_card_container">
                                ...
                                >
                                    <div className="Feature_card_left_content">
                                        ...
                                        <div className="Feature_card_subtitle">
                                            Или охлаждение. Смотря какое время
                                            года. Включается по кнопке в
                                            приложении.
                                        </div>
                                    </div>
                                    <img
