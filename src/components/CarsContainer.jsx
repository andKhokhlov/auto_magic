        ...
        <div className="Cars_container">
            ...
            <div className='Cars_container_content'>
                <div className='Cars_section_header_mobile'>
                    <div className='Cars_section_header_title_mobile' style={{color: 'rgb(19,136,8)'}}>На каждый день
                    </div>
            ...
            <div className='Cars_container_content'>
                <div className='Cars_section_header_mobile'>
                    <div className='Cars_section_header_title_mobile' style={{color: 'rgb(19,136,8)'}}>Праздник
                    </div>
                    <div className='Cars_section_header_subtitle_mobile'>Нужны 26 лет жизни и 6 стажа, 30 км пробега и
                        рейтинг 42
                    </div>
                </div>
            ...
            <div className='Cars_container_content'>
                <div className='Cars_section_header_mobile'>
                    <div className='Cars_section_header_title_mobile' style={{color: 'rgb(19,136,8)'}}>Жара
                    </div>
                    <div className='Cars_section_header_subtitle_mobile'>Нужны 26 лет жизни и 6 стажа, 30 км пробега и
                        рейтинг 42
                    </div>
            ...
            <div className='Cars_container_content'>
                <div className='Cars_section_header_mobile'>
                    <div className='Cars_section_header_title_mobile' style={{color: 'rgb(19,136,8)'}}>Молния
                    </div>
                    <div className='Cars_section_header_subtitle_mobile'>Нужны 26 лет жизни и 6 стажа, 30 км пробега и
                        рейтинг 42
                    </div>
                ...
                <div className='Cars_section_models'>
                    <div className='Car_card_container'>
                        <div className='Car_card' style={{backgroundColor: 'rgb(106, 90, 205)'}}>
                            <img src={Nissan} className='Car_card_icon'></img>
                            <div className='Car_card_title' style={{color: 'rgb(255, 255, 255)'}}>Nissan Leaf</div>
                        </div>
                    </div>
                </div>
            </div>
            <div className='Cars_container_content'>
                <div className='Cars_section_header_mobile'>
                    <div className='Cars_section_header_title_mobile' style={{color: 'rgb(19,136,8)'}}>Груз и шаттл
                    </div>
                    <div className='Cars_section_header_subtitle_mobile'>Нужны 21 год жизни и 2 года стажа
                    </div>
                </div>
